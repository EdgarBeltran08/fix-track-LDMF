...
const InventoryPage: React.FC = () => {
  ...
  return (
    <View className="flex-1 pt-5 mb-8 items-start bg-background-50">
      <Text className="text-3xl font-bold ml-6 mb-4 text-secondary-900">Inventario</Text>
...
<Button 
  size="lg" 
  className="ml-4 rounded-full p-2 bg-background-primary-50 border-2 border-secondary-300 flex-row justify-center items-center h-11" >
  <FontAwesome6 name="add" size={24} color="gray" className="align-middle translate-y-[-2px]" /> 
</Button>
</View>
            ...
            <Table className="min-w-[600px] border-2 border-secondary-300 rounded-md overflow-visible">
              <TableHeader>
                <TableRow className="bg-background-50 border-b-2 border-secondary-300">
                  <TableHead className="text-secondary-900 text-center px-2">Repuesto</TableHead>
                  <TableHead className="text-secondary-900 text-center px-2">Cantidad</TableHead>
                  <TableHead className="text-secondary-900 text-center px-2">ID</TableHead>
                  <TableHead className="text-secondary-900 text-center px-2">Categoría</TableHead>
                  <TableHead className="text-secondary-900 text-center px-2">Estado</TableHead>
                  <TableHead className="text-secondary-900 text-center px-2">Detalle</TableHead>
                </TableRow>
              </TableHeader>
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal} size="lg">
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button variant="outline" action="secondary" onPress={handleCloseModal}>
